...
namespace RobotUI.Utils
{
    public class ScriptTreeViewUtils
    {
        ...
        public static void DuplicateSelectedTreeViewItem(TreeView treeView)
        {
            ...
            {
                var c = (Robot.Command)ScriptManager.Instance.LoadedScripts[treeView.SelectedNode.Parent.Index].Commands[treeView.SelectedNode.Index].Clone();
